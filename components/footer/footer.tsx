...
import WebDashboardMockup from "@/components/mockups/web-mockup";
        ...
        <div className="bg-[#CDFF4D] rounded-3xl p-8 md:p-12 lg:p-16">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            <div className="flex-1 max-w-lg">
              <h1 className="text-2xl grotesk md:text-4xl lg:text-5xl font-bold text-black leading-tight mb-4">
                Power Up Your Farm Experience with the ztrack app
              </h1>
              <p className="text-gray-700 text-base md:text-lg mb-8">
                Monitor your agricultural machines, track sensor data in
                real-time, and access smart diagnostics all in one app. 
