'use client'
export default function BgBelowShade() {
  const clipPathStyle = {
    clipPath: `polygon(
      74.1% 44.1%,
      100% 61.6%,
  ...
  return (
    <>
      {/* Blur 1 — Bottom Center */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 bottom-0 transform-gpu overflow-hidden blur-3xl sm:bottom-14"
      >
        <div
          style={clipPathStyle}
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 right-[-95rem] transform-gpu overflow-hidden blur-3xl sm:bottom-28"
      >
        <div
          style={clipPathStyle}
          className="relative left-1/2 aspect-[1155/678] w-[36rem]
